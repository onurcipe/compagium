import {isPresent, isPopulated, clone} from "../../../util/core/value.js";
...
type MongoDBModelDefinition =
    {
        ...
        /* Object */
        properties?: {[property: string]: MongoDBModelDefinition};
        ...
        dependencies?: {[property: string]: string[] | MongoDBModelDefinition};
...
type MongoDBJsonSchema =
    ...
    &
    {
        ...
        /* Object */
        properties?: {[property: string]: MongoDBJsonSchema};
